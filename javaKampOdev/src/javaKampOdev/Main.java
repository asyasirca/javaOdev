...
public class Main {
	...
	public static void main(String[] args) {
		...
		UserAccount userAccount1 = new UserAccount("AGül AS","asya0077@kodlama.io",12345);
	    UserAccount userAccount2 = new UserAccount("Þeyma Þen","seymasen@kodlama.io",67890);
	    ...
	    //kursa ne ekleyecek?addCourse () içine eklenecek olan data yazýlýr.yoksa addCourse kýzar.
